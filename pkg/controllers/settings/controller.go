...
import (
	...
	"github.com/ekristen/pipeliner/pkg/settings"
)

func Register(settingController pipelinerc.SettingController) error {
	sp := &settingsProvider{
...
type settingsProvider struct {
	settings     pipelinerc.SettingClient
	settingCache pipelinerc.SettingCache
